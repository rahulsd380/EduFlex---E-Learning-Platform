...
const Footer = () => {
    return (
        <div className="bg-neutral-5 py-14 w-full mt-20">
            ...
            <p className=" text-primary-4 text-base font-normal mt-5">Top learning experiences that create more <br /> talent in the world.</p>
        </div>

        <div className="flex flex-col gap-4">
            <h1 className="text-dark-10 text-base font-semibold">Company</h1>

            <div className="flex flex-col gap-3">
                <Link to={"/"} className="text-primary-4 text-[14px] font-medium">Courses</Link>
                <Link to={"/"} className="text-primary-4 text-[14px] font-medium">About Us</Link>
                <Link to={"/"} className="text-primary-4 text-[14px] font-medium">Blogs</Link>
                <Link to={"/"} className="text-primary-4 text-[14px] font-medium">Instructors</Link>
                <Link to={"/"} className="text-primary-4 text-[14px] font-medium">Services</Link>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center mt-12">
                <p className="text-dark-10 text-base">© 2022 Ed-Circle. All rights reserved.</p>
