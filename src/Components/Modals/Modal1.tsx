...
const Modal1 : React.FC<ModalProps> = ({children,openModal1, setOpenModal1, classNames}) => {
    return (
        <div className="mx-auto w-fit">
            <div onClick={() => setOpenModal1(false)} className={`fixed z-[100] w-screen ${openModal1 ? 'visible opacity-100' : 'invisible opacity-0'} inset-0 grid place-items-center bg-neutral-60/60 duration-100 dark:bg-transparent`}>
