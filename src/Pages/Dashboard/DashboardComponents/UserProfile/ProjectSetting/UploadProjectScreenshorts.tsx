...
const UploadProjectScreenshorts = () => {
  ...
  const handleClearFile = () => {
    ...
    return (
      ...
      {showName?.name ? (
        <div className=" mx-auto flex max-w-[600px] items-center gap-x-6  rounded-lg border border-dashed border-gray-400 p-5 bg-white">
...
export default UploadProjectScreenshorts;