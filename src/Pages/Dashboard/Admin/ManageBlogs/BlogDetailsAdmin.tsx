...
import { TComment } from "../../../Blog/blog.types";
  ...
  return (
    <div className="flex gap-10 font-Roboto">
      ...
      <div className="flex flex-col gap-5 w-[30%] bg-dark-5/40 border border-dark-10/30 rounded-lg p-4 h-fit max-h-[890px] overflow-y-auto custom-scrollbar">
        <h1 className="text-body-text text-3xl font-medium">Related Blogs</h1>
      ...
      <div className="w-[70%] flex flex-col gap-5 bg-dark-5/40 border border-dark-10/30 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-body-text text-3xl font-medium">{title}</h1>
            ...
            <div className="group flex flex-col items-center justify-center w-max mx-auto absolute top-0 left-[50%] -translate-x-1/2">
              ...
              <div className="space-y-4 duration-500 h-0 group-hover:my-4 group-hover:h-full ">
                ...
                {svgs?.map((svg, idx) => (
                  <div
                    key={idx}
                    className={`hover:cursor-pointer w-10 h-10 -rotate-90 rounded-full scale-0 group-hover:scale-100 duration-300 shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] opacity-0 group-hover:opacity-100 ${
                      idx === 0
                  ...
                  >
                    <div className="w-full h-full bg-white hover:bg-dark-5 flex justify-center items-center rounded-full duration-300">
                      {svg?.svg}
                    </div>
                  </div>
                ))}
        ...
        <div className="flex justify-start">
          <button className="px-4 py-2 rounded-md bg-primary-10 text-white">
            Read More
          </button>
        </div>
        ...
        {/* Comment */}
        <div>
          <h1 className="text-body-text text-xl font-medium">Comments</h1>
          ...
          <div className="p-3 border border-dark-10/30 rounded-lg flex flex-col gap-4">
            ...
            <textarea
              ...
              rows={5}
              className="w-full p-3 border border-dark-10/30 rounded-lg focus:border-primary-10 transition duration-300 focus:outline-none"
            ></textarea>
            ...
            <div className="flex flex-col gap-7">
              {comments.map((comment : TComment) => (
                <div
                  key={comment?._id}
                  className="border-b border-dark-10/50 pb-5 flex flex-col gap-3"
                >
                  <div className="flex items-center gap-3">
                    <img src={avatar1} alt="" />
                    <p>
                  ...
                  <div className="border border-dark-10/40  w-fit rounded-lg px-3 py-2">
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="h-[20px] w-0.5 bg-gray-300"></div>

                      <div className="flex items-center gap-1">
                        <p className="text-sm text-gray-500">
                          {comment.disappreciated}
                        </p>
